        ...
        try:
            ...
            for author in bibdata.entries[bib_id].persons["author"]:
                ...
                if author.first_names[0]=="Zhedong":
                    ...
                    allauthor = allauthor+"<img src=\"https://zdzheng.xyz/files/"+coname.lower()+ ".jpeg\"alt=\"%s\""%coname + "style=\"border-radius: 50%; height:20px; width:20px\">" + "<a href=\"https://zdzheng.xyz/authors/"+ author.first_names[0]+"-"+author.last_names[0].replace('*','')+"\" class=\"author\">" + author.first_names[0]+" "+author.last_names[0] + "</a>" +", "
                else:
