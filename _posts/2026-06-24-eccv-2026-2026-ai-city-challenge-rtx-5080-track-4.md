...
tags:
- city challenge 的奖项已正式确认
- ai city challenge
- super developer kit
- 开放基准测试 open benchmarks
- open benchmarks 的重要性日益凸显
- benchmarks 的重要性日益凸显
---
...
- **官方网站**：[AI City Challenge 2026 官网](https://www.aicitychallenge.org/2026/) *(注：请替换为真实URL)*
- **Track 4 详细说明与数据集下载**：[Track 4 赛道主页](https://www.aicitychallenge.org/2026/tracks/track4/) *(注：请替换为真实URL)*
- **评测服务器 (Evaluation Server)**：[CodaLab / 官方评测平台链接](https://codalab.org/...) *(注：请替换为真实URL)*
- **论文提交系统**：[ECCV 2026 Workshop 提交入口](https://...) *(注：请替换为真实URL)*
...
---
本文首发于郑哲东个人主页：
https://www.zdzheng.xyz/blog/eccv-2026-2026-ai-city-challenge-rtx-5080-track-4
